...
naniar::gg_miss_var(nutrients_wrangle) # graph shows how many NA's for each variable (showed none for the data I have selected)
...
- Sugar and carbs are positivel correlated.
